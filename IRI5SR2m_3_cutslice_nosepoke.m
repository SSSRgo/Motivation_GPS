...
%     rewardon = timeSeriesData.Tray_1;
    nosepokeon = Event.Nosepoke_slice1;  
    trayontime = Event.Nosepoke_slice2;  



    %  histogram(ton,'BinWidth',20);   %3600 second 3600/20=180
    [N1,nedges] = histcounts(nosepokeon,'BinWidth',BinWidth);
    [N2,nedges] = histcounts(trayontime,'BinWidth',BinWidth);
...
%% Event Response Tray on
            ...
            [NWindow_trayon,trayon_starpoint] = EventResonse(trayontime,cellTS,Li,Inti,binwidth);
...
%% Event Response Nose Poke
            ...
            [NWindow_nosepoke,nosepoke_starpoint] = EventResonse(nosepokeon,cellTS,Li,Inti,binwidth);
...
%% Event Response Nose Poke of FR count 1-3

            Li=-4;
            Inti=6;
            LeftBound=Li; RightBound=Li+Inti;
            TWindow_nosepoke=0:binwidth:(RightBound-LeftBound);
            [NWindow_nosepoke_Rcount_1,nosepoke_starpoint_Rcount_1] = EventResonse(Event.Nosepoke_slice1,cellTS,Li,Inti,binwidth);
            [NWindow_nosepoke_Rcount_2,nosepoke_starpoint_Rcount_2] = EventResonse(Event.Nosepoke_slice2,cellTS,Li,Inti,binwidth);
%             [NWindow_nosepoke_Rcount_3,nosepoke_starpoint_Rcount_3] = EventResonse(Event.Nosepoke_Rcount_3,cellTS,Li,Inti,binwidth);

            f_peak_nosepoke_count=figure;
...
%% Event Response Tray on Comparing Pump and Non-pump
...
%             f_peak_trayon=figure;
            ...
            TWindow_nosepoke=0:binwidth:(RightBound-LeftBound);
            [NWindow_Trayon_pump,] = EventResonse(Event.Trayon_slice1,cellTS,Li,Inti,binwidth);
            [NWindow_Trayon_nonpump,] = EventResonse(Event.Trayon_slice2,cellTS,Li,Inti,binwidth);
        

            f_peak_trayon_pump=figure;
%             set(gcf,'Units','normalized','position',[0.2,0.2,0.6,0.5])
...
%             exportgraphics(f_corr,[Egoname '_1' 'Trayon_pump&Nosepoke_Rcount_1' '.jpg'],'Resolution',300)
            exportgraphics(f_peak_trayon,[Egoname '_2' '_Nosepoke_slice2' '.jpg'],'Resolution',300)
            exportgraphics(f_peak_nosepoke,[Egoname '_3' '_Nosepoke_slice1' '.jpg'],'Resolution',300)


             exportgraphics(f_peak_nosepoke_count,[Egoname '_5' '_cutslice_nosepoke' '.jpg'],'Resolution',300)
             exportgraphics(f_peak_trayon_pump,[Egoname '_5' '_cutslice_trayon' '.jpg'],'Resolution',300)
