...
%     rewardon = timeSeriesData.Tray_1;
    nosepokeon = Event.Trayon_slice1;  
    trayontime = Event.Trayon_slice2;  
...
%             exportgraphics(f_corr,[Egoname '_1' 'Trayon_pump&Nosepoke_Rcount_1' '.jpg'],'Resolution',300)
            exportgraphics(f_peak_trayon,[Egoname '_2' '_Trayon_slice2' '.jpg'],'Resolution',300)
            exportgraphics(f_peak_nosepoke,[Egoname '_3' '_Trayon_slice1' '.jpg'],'Resolution',300)
