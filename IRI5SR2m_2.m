...
%% Event Response Tray on
            ...
            TWindow_trayon=0:0.2:(RightBound-LeftBound);
            [NWindow_trayon,trayon_starpoint] = EventResonse(trayontime,cellTS,Li,Inti);
...
%% Event Response Nose Poke
            ...
            Inti=15;
            LeftBound=Li; RightBound=Li+Inti;
            TWindow_nosepoke=0:0.2:(RightBound-LeftBound);
            [NWindow_nosepoke,nosepoke_starpoint] = EventResonse(nosepokeon,cellTS,Li,Inti);
...
%% Event Response Nose Poke of FR count 1-3
            ...
            LeftBound=Li; RightBound=Li+Inti;
            TWindow_nosepoke=0:0.2:(RightBound-LeftBound);
            [NWindow_nosepoke_Rcount_1,nosepoke_starpoint_Rcount_1] = EventResonse(Event.Nosepoke_Rcount_1,cellTS,Li,Inti);
            [NWindow_nosepoke_Rcount_2,nosepoke_starpoint_Rcount_2] = EventResonse(Event.Nosepoke_Rcount_2,cellTS,Li,Inti);
            [NWindow_nosepoke_Rcount_3,nosepoke_starpoint_Rcount_3] = EventResonse(Event.Nosepoke_Rcount_3,cellTS,Li,Inti);
