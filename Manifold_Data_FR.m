...
HighDimData_Name={'Nosepoke_FRcount_4'};
...
state_end=40;
max_state=120;
% data_save_name='HighDimData_FR_np2';  % 2 9 200
data_save_name='HighDimData_FR_np_2_8_200';  % 2 9 200
data_save_name='HighDimData_FR_np_2_8_400';  % 2 9 200
data_save_name='HighDimData_FR_np_2_8_2_2_400';  % 2 9 200
data_save_name='HighDimData_FR_np_2_8_2_2_800';  % 2 9 200

data_save_name='HighDimData_FR_np_2_100_2_2_200_6';  % state: 2_100 windows interval: 2_2 bin: 200
data_save_name='HighDimData_FR_np_2_100_2_2_200_9';  % state: 2_100 windows interval: 2_2 bin: 200
...
for i=2:max_state
    ...
    try
        % Note!!!: start from state 2
                [SpkWindow_Nosepoke]  = WindowPick(Event.(['Nosepoke_FRstate_' num2str(i)]),cellTS,WindowWidth,Ui,Li);
    catch exception
...
% 找到第120列为空的行
emptyRows = cellfun(@(x) isempty(x), ManifoldData(:, state_end));

% 删除空行
ManifoldData(emptyRows, :) = [];
...
for iiii=1:size(ManifoldData,1)
% HighDimData(i)
