...
% NEURONAL_SAMPLE_RATE = length(angle_per_temporal_bin); %Hz % SR
BEHAVIORAL_SAMPLES_PER_TEMPORAL_BIN = 4; %for now, we use only integer number of samples
NUMBER_OF_ANGLE_BINS = 121;
NUMBER_OF_ESTIMATED_ANGLE_BINS = 121;
...
% SAMPLE_LIMIT = length(angle_per_temporal_bin); % SR
...
% 
NUMBER_OF_ACTIVE_NEURONS_THRESHOLD = 0;% % SR: Set NUMBER_OF_ACTIVE_NEURONS_THRESHOLD = 0 (15)
