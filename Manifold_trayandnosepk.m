...
load('HighDimData_Nosepoke_Rcount_1.mat')
HighDimData1=HighDimData;
load('HighDimData_Nosepoke_Rcount_2.mat')
...
f10=figure
[W,y] = LDA_ClassIndependent(x, [600;400]);
scatter3(y(1:3*l,1),y(1:3*l,2),y(1:3*l,3), 20, cmap21(color_index_nosepk, :), 'fill');
hold on
% colormap(othercolor('Set27'));
scatter3(y(3*l+1:end,1),y(3*l+1:end,2),y(3*l+1:end,3), 20, cmap23(color_index_trayon, :), 'fill');
