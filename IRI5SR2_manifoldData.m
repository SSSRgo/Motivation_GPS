...
HighDimData=zeros(Size_NosepokeWiondow(2)+Size_RewardWiondow(2),length(ManifoldData));

for i=1:length(ManifoldData)
% HighDimData(i)
HighDimData(1:Size_NosepokeWiondow(2),i)=mean(ManifoldData{i,2});
...
save(HighDimData_Name,'HighDimData','Timelag_per_bin')
